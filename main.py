...
def main():
    ...
    raw_question_paper_text = ocr_extraction(["qn_paper.pdf"])
    cleaned_question_paper = clean_text(question_paper_text=raw_question_paper_text, mode="question_paper")  # No second argument for question paper cleaning
    ...
    raw_answers_text = ocr_extraction(["English_core.pdf"])
